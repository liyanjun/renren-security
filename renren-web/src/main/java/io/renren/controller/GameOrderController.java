...
public class GameOrderController {
    ...
    public List<JSONObject> colModel() {
        ...
        jsonObject2.put("label", "游戏名");
        jsonObject2.put("name", "name");
        jsonObject2.put("index", "name");
        jsonObject2.put("width", "80");
        JSONObject jsonObject3 = new JSONObject();
        jsonObject3.put("label", "游戏账号");
        jsonObject3.put("name", "account");
        jsonObject3.put("index", "account");
        jsonObject3.put("width", "80");
        JSONObject jsonObject4 = new JSONObject();
        jsonObject4.put("label", "是否处理");
        jsonObject4.put("name", "isHandle");
        jsonObject4.put("index", "isHandle");
        jsonObject4.put("width", "80");
        JSONObject jsonObject5 = new JSONObject();
        jsonObject5.put("label", "订单总额");
        jsonObject5.put("name", "totalAmount");
        jsonObject5.put("index", "totalAmount");
        jsonObject5.put("width", "80");
        JSONObject jsonObject6 = new JSONObject();
        jsonObject6.put("label", "购买数量");
        jsonObject6.put("name", "gamePriceNumber");
        jsonObject6.put("width", "80");
        JSONObject jsonObject7 = new JSONObject();
        jsonObject7.put("label", "购买面额");
        jsonObject7.put("name", "gamePrice");
        jsonObject7.put("width", "80");
        ...
        for (GamePropertyEntity gameProperty : gamePropertyEntities) {
            ...
            jo.put("label", gameProperty.getLabel());
            jo.put("name", gameProperty.getName());
            jo.put("width", "80");
            gameOrderCol.add(jo);
        }
